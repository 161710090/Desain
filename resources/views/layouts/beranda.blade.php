      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('{{asset('assets/img/intro-carousel/1.jpg')}}');">
            <div class="carousel-container">
              <div class="carousel-content">
               ...
               <p> Selamat datang di situs Resmi MTs Nurul Iman</h1></p>
                <img src="{{asset('assets/img/lg.jpg')}}">
                <p><br>Islamic Scool Education<br>
            Membuat Lulusan Yang Berahlak Mulia Amanah Fathonah Tawadhu 
            </p>
          ...
          <div class="carousel-item" style="background-image: url('{{asset('assets/img/intro-carousel/2.jpg')}}');">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>PPBD MTs Nurul Iman</h2>
                <p class="slider-content-text" data-swiper-parallax="-200" style="transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;"> MTs Nurul Iman menerima pendaftaran Siswa/i baru ..... </p>
                <a href="#featured-services" class="btn-get-started scrollto">Daftar Sekarang</a>
              </div>
            </div>
          </div>
